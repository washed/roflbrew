...
// Include hardware-specific functions for the correct MCU
  ...
  #include "hardware/pic32/HW_PIC32.h"
	...
	//#include "hardware/arm/HW_ARM.h"
		...
		#pragma message("Compiling for STM32F407xx...")
...
UTFT::UTFT(uint8_t model, int RS, int WR, int CS, int RST, int SER)
{ 
	...
	uint16_t	dsy[] = {319, 399, 319, 319, 319, 319, 219, 219, 399, 159,		// 00-09
					 ...
					 159, 159};												// 30-
	uint8_t		dtm[] = {16, 16, 16, 8, 8, 16, 8, SERIAL_4PIN, 16, SERIAL_5PIN,					// 00-09
